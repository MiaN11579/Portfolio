...
import { Starcraft } from "@/constants";
      ...
      <div className='flex flex-col relative items-center project-padding z-40'>
        ...
        >
          <p
            ...
            A Terran bot that fights against the built-in StarCraft Broodwar Bot using a good general-purpose strategy and combat units. Made with BWAPI and C++.
          </p>
        </motion.div>

        <div className="flex flex-row justify-center flex-wrap items-center">
          {Starcraft.map((image, index) => (
            <SkillDataProvider
              key={index}
