    ...
    return (
        <div>
            <motion.div
                initial='hidden'
                animate='visible'
                className='relative flex flex-row items-center justify-center page-padding mt-40 mb-20 w-full z-40'>
                <div className='h-full w-full flex flex-col gap-6 justify-center m-auto text-start'>
                    ...
                    <motion.div
                        ...
                        className='flex flex-col gap-6 mt-6 text-7xl font-bold text-white max-w-[1000px] w-auto h-auto'>
                        <span>
                            Hello! My name is
                    ...
                    <motion.a
                        ...
                        className='text lg text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-cyan-500 text-2xl my-8 max-w-[1000px]'>
                        Let&apos;s talk!
                    </motion.a>
                </div>
