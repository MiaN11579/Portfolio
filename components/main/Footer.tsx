...
const Footer = () => {
    return (
        <div className='w-full h-[120px] relative overflow-hidden bottom-0 shadow-lg shadow-lg shadow-[#2A0E61]/50 bg-[#0300145e] backdrop-blur-md z-50'>
            <div className='w-full h-full flex flex-col items-center justify-center'>
                ...
                <div className='w-[100px] md:w-[200px] h-full flex flex-row items-center justify-between z-50'>
